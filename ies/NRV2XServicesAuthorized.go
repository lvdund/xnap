...
var nRV2XServicesAuthorizedConstraints = per.SequenceConstraints{
	Extensible: true,
...
func (ie *NRV2XServicesAuthorized) Encode(e *per.Encoder) error {
	seq := e.NewSequenceEncoder(nRV2XServicesAuthorizedConstraints)
...
func (ie *NRV2XServicesAuthorized) Decode(d *per.Decoder) error {
	seq := d.NewSequenceDecoder(nRV2XServicesAuthorizedConstraints)
