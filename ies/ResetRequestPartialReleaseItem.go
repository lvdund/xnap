...
var resetRequestPartialReleaseItemConstraints = per.SequenceConstraints{
	Extensible: true,
...
func (ie *ResetRequestPartialReleaseItem) Encode(e *per.Encoder) error {
	seq := e.NewSequenceEncoder(resetRequestPartialReleaseItemConstraints)
...
func (ie *ResetRequestPartialReleaseItem) Decode(d *per.Decoder) error {
	seq := d.NewSequenceDecoder(resetRequestPartialReleaseItemConstraints)
