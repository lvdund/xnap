...
var resourceCoordRequestNgENBInitiatedConstraints = per.SequenceConstraints{
	Extensible: true,
...
func (ie *ResourceCoordRequestNgENBInitiated) Encode(e *per.Encoder) error {
	seq := e.NewSequenceEncoder(resourceCoordRequestNgENBInitiatedConstraints)
...
func (ie *ResourceCoordRequestNgENBInitiated) Decode(d *per.Decoder) error {
	seq := d.NewSequenceDecoder(resourceCoordRequestNgENBInitiatedConstraints)
