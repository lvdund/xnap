...
var pDUSessionAdmittedToBeAddedSNModResponseItemConstraints = per.SequenceConstraints{
	Extensible: true,
...
func (ie *PDUSessionAdmittedToBeAddedSNModResponseItem) Encode(e *per.Encoder) error {
	seq := e.NewSequenceEncoder(pDUSessionAdmittedToBeAddedSNModResponseItemConstraints)
...
func (ie *PDUSessionAdmittedToBeAddedSNModResponseItem) Decode(d *per.Decoder) error {
	seq := d.NewSequenceDecoder(pDUSessionAdmittedToBeAddedSNModResponseItemConstraints)
