...
var pDUSessionToBeAddedAddReqItemConstraints = per.SequenceConstraints{
	Extensible: true,
...
func (ie *PDUSessionToBeAddedAddReqItem) Encode(e *per.Encoder) error {
	seq := e.NewSequenceEncoder(pDUSessionToBeAddedAddReqItemConstraints)
...
func (ie *PDUSessionToBeAddedAddReqItem) Decode(d *per.Decoder) error {
	seq := d.NewSequenceDecoder(pDUSessionToBeAddedAddReqItemConstraints)
