...
var servedCellsNRItemConstraints = per.SequenceConstraints{
	Extensible: true,
...
func (ie *ServedCellsNRItem) Encode(e *per.Encoder) error {
	seq := e.NewSequenceEncoder(servedCellsNRItemConstraints)
...
func (ie *ServedCellsNRItem) Decode(d *per.Decoder) error {
	seq := d.NewSequenceDecoder(servedCellsNRItemConstraints)
