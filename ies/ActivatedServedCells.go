...
const (
	ActivatedServedCellsChNrCells         = 0
	ActivatedServedCellsChEUtraCells      = 1
	ActivatedServedCellsChChoiceExtension = 2
)

var activatedServedCellsConstraints = per.ChoiceConstraints{
	Extensible: false,
...
func (ie *ActivatedServedCells) Encode(e *per.Encoder) error {
	choice := e.NewChoiceEncoder(activatedServedCellsConstraints)
	switch ie.Choice {
	case 0: // nr-cells
...
func (ie *ActivatedServedCells) Decode(d *per.Decoder) error {
	choice := d.NewChoiceDecoder(activatedServedCellsConstraints)
