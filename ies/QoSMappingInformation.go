...
var qoSMappingInformationConstraints = per.SequenceConstraints{
	Extensible: true,
...
func (ie *QoSMappingInformation) Encode(e *per.Encoder) error {
	seq := e.NewSequenceEncoder(qoSMappingInformationConstraints)
...
func (ie *QoSMappingInformation) Decode(d *per.Decoder) error {
	seq := d.NewSequenceDecoder(qoSMappingInformationConstraints)
